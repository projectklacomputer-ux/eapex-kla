...
// Umur ekonomis (tahun) per kategori aset CAPEX -- otomatis dari kategori aset,
// TIDAK bisa diubah pemohon. Bukan kolom basis data: dihitung ulang dari
// kategori_aset yang sudah tersimpan, di mana pun ditampilkan (formulir,
// detail, cetakan) -- satu sumber, tidak bisa mencong.
const UMUR_ASET = { Bangunan: 20, Kendaraan: 8, Inventaris: 4, 'Peralatan IT': 4, Lainnya: 4 };
const umurAset = kategori => UMUR_ASET[kategori] || null;
...
module.exports = {
  ...
  TUJUAN_CAPEX, KATEGORI_ASET, UMUR_ASET, umurAset, IKON_GRUP, ikonGrup,
};
